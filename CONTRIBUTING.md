...
# Change directory to the pod_sentinel directory
...
jupyter server extension enable pod_sentinel
...
jupyter server extension disable pod_sentinel
...
folder is located. Then you can remove the symlink named `pod-sentinel` within that folder.
